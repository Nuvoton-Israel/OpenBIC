...
uint32_t GPIO_GROUP_REG_ACCESS[GPIO_GROUP_NUM] = {
	REG_GPIO_BASE + 0x00, /* GPIO_0 */
	REG_GPIO_BASE + 0x2000, /* GPIO_1 */
	REG_GPIO_BASE + 0x4000, /* GPIO_2 */
	REG_GPIO_BASE + 0x6000, /* GPIO_3 */
	REG_GPIO_BASE + 0x8000, /* GPIO_4 */
	REG_GPIO_BASE + 0xA000, /* GPIO_5 */
	REG_GPIO_BASE + 0xC000, /* GPIO_6 */
	REG_GPIO_BASE + 0xE000, /* GPIO_7 */
	REG_GPIO_BASE + 0x10000, /* GPIO_8 */
	REG_GPIO_BASE + 0x12000, /* GPIO_9 */
	REG_GPIO_BASE + 0x14000, /* GPIO_A */
	REG_GPIO_BASE + 0x16000, /* GPIO_B */
	REG_GPIO_BASE + 0x18000, /* GPIO_C */
	REG_GPIO_BASE + 0x1A000, /* GPIO_D */
	REG_GPIO_BASE + 0x1C000, /* GPIO_E */
	REG_GPIO_BASE + 0x1E000, /* GPIO_F */
};
...
void irq_callback(const struct device *dev, struct gpio_callback *cb, uint32_t pins)
{
	...
	if (dev == dev_gpio[GPIO_0]) {
		group = GPIO_0;
	} else if (dev == dev_gpio[GPIO_1]) {
		group = GPIO_1;
	} else if (dev == dev_gpio[GPIO_2]) {
		group = GPIO_2;
	} else if (dev == dev_gpio[GPIO_3]) {
		group = GPIO_3;
	} else if (dev == dev_gpio[GPIO_4]) {
		group = GPIO_4;
...
{
#ifdef DEV_GPIO_0
	dev_gpio[GPIO_0] = device_get_binding("GPIO_0");
#endif
#ifdef DEV_GPIO_1
	dev_gpio[GPIO_1] = device_get_binding("GPIO_1");
#endif
#ifdef DEV_GPIO_2
	dev_gpio[GPIO_2] = device_get_binding("GPIO_2");
#endif
#ifdef DEV_GPIO_3
	dev_gpio[GPIO_3] = device_get_binding("GPIO_3");
#endif
#ifdef DEV_GPIO_4
	dev_gpio[GPIO_4] = device_get_binding("GPIO_4");
#endif
#ifdef DEV_GPIO_5
	dev_gpio[GPIO_5] = device_get_binding("GPIO_5");
#endif
#ifdef DEV_GPIO_6
	dev_gpio[GPIO_6] = device_get_binding("GPIO_6");
#endif
#ifdef DEV_GPIO_7
	dev_gpio[GPIO_7] = device_get_binding("GPIO_7");
#endif
#ifdef DEV_GPIO_8
	dev_gpio[GPIO_8] = device_get_binding("GPIO_8");
#endif
#ifdef DEV_GPIO_9
	dev_gpio[GPIO_9] = device_get_binding("GPIO_9");
#endif
#ifdef DEV_GPIO_A
	dev_gpio[GPIO_A] = device_get_binding("GPIO_A");
#endif
#ifdef DEV_GPIO_B
	dev_gpio[GPIO_B] = device_get_binding("GPIO_B");
#endif
#ifdef DEV_GPIO_C
	dev_gpio[GPIO_C] = device_get_binding("GPIO_C");
#endif
#ifdef DEV_GPIO_D
	dev_gpio[GPIO_D] = device_get_binding("GPIO_D");
#endif
#ifdef DEV_GPIO_E
	dev_gpio[GPIO_E] = device_get_binding("GPIO_E");
#endif
#ifdef DEV_GPIO_F
	dev_gpio[GPIO_F] = device_get_binding("GPIO_F");
#endif
}
